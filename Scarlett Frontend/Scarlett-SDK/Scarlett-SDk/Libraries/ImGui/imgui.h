...
namespace ImGui
{
    ...
    IMGUI_API bool          Loading(const char* itemid, float radius, int thickness, int multicoloralpha, const ImU32& darkcolor, ImDrawList* drawlist, CircleAnimBase flags);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.f, ImDrawFlags flags = 0.f);
